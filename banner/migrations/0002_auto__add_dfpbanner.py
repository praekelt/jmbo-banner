...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DFPBanner'
        db.create_table('banner_dfpbanner', (
            ('banner_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['banner.Banner'], unique=True, primary_key=True)),
            ('slot_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('width', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('height', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('targeting_key', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('targeting_values', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('banner', ['DFPBanner'])


    def backwards(self, orm):
        # Deleting model 'DFPBanner'
        db.delete_table('banner_dfpbanner')
