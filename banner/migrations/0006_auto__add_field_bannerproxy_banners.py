...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field banners on 'BannerProxy'
        db.create_table('banner_bannerproxy_banners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bannerproxy', models.ForeignKey(orm['banner.bannerproxy'], null=False)),
            ('banner', models.ForeignKey(orm['banner.banner'], null=False))
        ))
        db.create_unique('banner_bannerproxy_banners', ['bannerproxy_id', 'banner_id'])


    def backwards(self, orm):
        # Removing M2M table for field banners on 'BannerProxy'
        db.delete_table('banner_bannerproxy_banners')
