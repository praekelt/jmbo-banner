...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CodeBanner'
        db.create_table('banner_codebanner', (
            ('banner_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['banner.Banner'], unique=True, primary_key=True)),
            ('code', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('banner', ['CodeBanner'])

        # Adding model 'ImageBanner'
        db.create_table('banner_imagebanner', (
            ('banner_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['banner.Banner'], unique=True, primary_key=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length='256')),
        ))
        db.send_create_signal('banner', ['ImageBanner'])

        # Adding model 'BannerOption'
        db.create_table('banner_banneroption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banner_preferences', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['preferences.BannerPreferences'])),
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('url_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal('banner', ['BannerOption'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CodeBanner'
        db.delete_table('banner_codebanner')

        # Deleting model 'ImageBanner'
        db.delete_table('banner_imagebanner')

        # Deleting model 'BannerOption'
        db.delete_table('banner_banneroption')
    ...
    models = {
        ...
        'banner.imagebanner': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'ImageBanner', '_ormbases': ['banner.Banner']},
            'banner_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['banner.Banner']", 'unique': 'True', 'primary_key': 'True'}),
