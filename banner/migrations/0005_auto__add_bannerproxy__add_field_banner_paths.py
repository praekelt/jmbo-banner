...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BannerProxy'
        db.create_table('banner_bannerproxy', (
            ('modelbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['jmbo.ModelBase'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('banner', ['BannerProxy'])

        # Adding field 'Banner.paths'
        db.add_column('banner_banner', 'paths',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BannerProxy'
        db.delete_table('banner_bannerproxy')

        # Deleting field 'Banner.paths'
        db.delete_column('banner_banner', 'paths')
    ...
    models = {
        ...
        'banner.banner': {
            ...
            'paths': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        'banner.banneroption': {
